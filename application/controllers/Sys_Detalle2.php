<?php class Sys_Detalle2 extends CI_Controller {
	...
	return $valor;
	 ...
	 if (isset($_GET['proveedor'])) {
            ...
            $this->Tpo_model->initialize("tab_proveedores");
            $proveedor = $this->Tpo_model->find1("id_proveedor", $string, 1);
            setD3D("proveedor_name",  $proveedor[0]->nombre_razon_social);
         }
