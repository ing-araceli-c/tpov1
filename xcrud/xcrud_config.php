...
if (file_exists('data/config.php')) include_once( 'data/config.php');
if (file_exists('../data/config.php')) include_once( '../data/config.php');
...
class Xcrud_config
{
    ...
    public static $alt_lifetime = 300; // in minutes, maximum time between requests when instance's data can be valid
    ...
    public static $column_cut = 150; // Sets the maximum number of characters in the column.
    ...
    public static $lists_null_opt = false; // display null(empty) option in all dropdowns and multiselects
