...
<div class="bp-navBar" style="left:20px;">
    <ul class="bp-navigation clearfix" style="list-style-type:none">
        <li id="federalButton" class="button selected">Ambos</li>
        <li id="stateButton" class="button">Campañas</li>
        <li id="localButton" class="button">Avisos</li>
    </ul>
</div>
