...
function makeGraphs(error, apiData) {	
   ...
   var state           = ndx.dimension(function(d) { return d.ejercicio;       });
   ...
   var netTotalResourcetype = ndx.groupAll().reduceSum(function(d) {return 1;});
   ...
   var netDonations       = dc.numberDisplay("#Presupuesto");
   ...
   totalCampanas.formatNumber(d3.format("d"))
                .valueAccessor(function(d){return d; })
                .group(netTotalResourcetype)
                .formatNumber(d3.format("3s"));
   
   netDonations.formatNumber(d3.format("d"))
               .valueAccessor(function(d){return d; })
