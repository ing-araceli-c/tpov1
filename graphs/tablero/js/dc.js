...
/*LFC6 INI */
    ...
    _chart.title(function (d) {
        return _chart.cappedKeyAccessor(d) + '\n Monto ejercido: $ ' + numberWithCommas(_chart.cappedValueAccessor(d));
    });
/*LFC6 FIN */
...
/*LFC4*/
   ...
   if (_chart.__dcFlag__ == 2) {
      ylabel = "Partida";   
   }

   if (_chart.__dcFlag__ == 3) {
      ylabel = "Tipos de servicio";   
   }

   if (_chart.__dcFlag__ == 5) {
      ylabel = "Campañas y avisos";   
   }
    ...
    function updateLabels(rows) {
        if (_chart.renderLabel()) {
            var lab = rows.select('text')
                ...
                .text(function (d) {
                    var str = _chart.label()(d);
                    return str.substring(0, 45);;
/*LFC*                    return _chart.label()(d);*/
                });
