  ...
  Budget.Init = {
    ...
    */
    adjustPerCapita: function(lineItems){
      ...
      var perCapitaDivisor = {
        '2016': '310000', '2015': '310000', '2014': '310000', '2013': '310000'
      };
      var years = _.range(1976, 2018);
      _.each(lineItems, function(i){
          var l = JSON.parse(JSON.stringify(i));
    ...
    */
    loadExpenseLineItems: function(){
      var items = [];
      var that = this;
      d3.csv('graphs/campanasarbol/public/us_budget_expenses_2013.csv', function(csv){
//      d3.csv('public/us_budget_expenses_2013.csv', function(csv){
    ...
    */
    loadIncomeLineItems: function(){
      var items = [];
      var that = this;
      d3.csv('graphs/campanasarbol/public/us_budget_revenues_2013.csv', function(csv){
  ...
  */
  ...
  Budget.Display = {
    ...
    populateList: function(f){
      ...
      var amountUnit = Budget.State.capitaTracker === "per_capita" ? "per person" : "Miles";
    ...
    populateYearlySummary: function(year){
      ...
      $('.summary_year').html("<strong>"+ Budget.State.yearTracker + " Resumen:</strong>");
      $('.summary_expenses').html("Avisos - " + toDollarSummary(expenses));
      $('.summary_receipts').html("Campañas - " + toDollarSummary(receipts));
      $('.summary_net').html("Total - " + toDollarSummary(net));
    },
  ...
  var toDollarSummary = function(d){
    return "$" + (d/1000000).toFixed(0).replace(/(\d)(?=(\d{3})+\b)/g,'$1,') + " Miles";
  };
